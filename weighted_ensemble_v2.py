...
def we_histogram_msm(state, params):
    ...
    return (x, e, w, cb, b, propagator, observables, cumulative_aggregate_time, cumulative_molecular_time), (cumulative_aggregate_time, cumulative_molecular_time, est_bin_pops, eqp_msm), cumulative_aggregate_time >= aggregate_simulation_limit
